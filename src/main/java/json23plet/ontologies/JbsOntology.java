    ...
    extends BaseOntology
{
    ...
    public static Resource JBO_C_TANACHBOOK = (model.getOntClass(JBO_URI + "TanachBook"));
    public static Resource JBO_C_BERESHITBOOK = (model.getOntClass(JBO_URI + "BereshitBook"));
    public static Resource JBO_C_SHEMOTBOOK = (model.getOntClass(JBO_URI + "ShemotBook"));
    public static Resource JBO_C_VAYIKRABOOK = (model.getOntClass(JBO_URI + "VayikraBook"));
    public static Resource JBO_C_BAMIDBARBOOK = (model.getOntClass(JBO_URI + "BamidbarBook"));
    public static Resource JBO_C_DEVARIMBOOK = (model.getOntClass(JBO_URI + "DevarimBook"));
    public static Resource JBO_C_YEHOSHUABOOK = (model.getOntClass(JBO_URI + "YehoshuaBook"));
    public static Resource JBO_C_SHOFTIMBOOK = (model.getOntClass(JBO_URI + "ShoftimBook"));
    public static Resource JBO_C_SHEMUELABOOK = (model.getOntClass(JBO_URI + "ShemuelABook"));
    public static Resource JBO_C_SHEMUELBBOOK = (model.getOntClass(JBO_URI + "ShemuelBBook"));
    public static Resource JBO_C_MELACHIMABOOK = (model.getOntClass(JBO_URI + "MelachimABook"));
    public static Resource JBO_C_MELACHIMBBOOK = (model.getOntClass(JBO_URI + "MelachimBBook"));
    public static Resource JBO_C_YESHAAYABOOK = (model.getOntClass(JBO_URI + "YeshaayaBook"));
    public static Resource JBO_C_YIRMIYABOOK = (model.getOntClass(JBO_URI + "YirmiyaBook"));
    public static Resource JBO_C_YECHEZKELBOOK = (model.getOntClass(JBO_URI + "YechezkelBook"));
    public static Resource JBO_C_HOSHEABOOK = (model.getOntClass(JBO_URI + "HosheaBook"));
    public static Resource JBO_C_YOELBOOK = (model.getOntClass(JBO_URI + "YoelBook"));
    public static Resource JBO_C_AMOSBOOK = (model.getOntClass(JBO_URI + "AmosBook"));
    public static Resource JBO_C_OVADYABOOK = (model.getOntClass(JBO_URI + "OvadyaBook"));
    public static Resource JBO_C_YONABOOK = (model.getOntClass(JBO_URI + "YonaBook"));
    public static Resource JBO_C_MICHABOOK = (model.getOntClass(JBO_URI + "MichaBook"));
    public static Resource JBO_C_NACHUMBOOK = (model.getOntClass(JBO_URI + "NachumBook"));
    public static Resource JBO_C_CHAVAKUKBOOK = (model.getOntClass(JBO_URI + "ChavakukBook"));
    public static Resource JBO_C_TZEFANYABOOK = (model.getOntClass(JBO_URI + "TzefanyaBook"));
    public static Resource JBO_C_CHAGAYBOOK = (model.getOntClass(JBO_URI + "ChagayBook"));
    public static Resource JBO_C_ZECHARYABOOK = (model.getOntClass(JBO_URI + "ZecharyaBook"));
    public static Resource JBO_C_MALACHIBOOK = (model.getOntClass(JBO_URI + "MalachiBook"));
    public static Resource JBO_C_TEHILIMBOOK = (model.getOntClass(JBO_URI + "TehilimBook"));
    public static Resource JBO_C_MISHLEYBOOK = (model.getOntClass(JBO_URI + "MishleyBook"));
    public static Resource JBO_C_IYOVBOOK = (model.getOntClass(JBO_URI + "IyovBook"));
    public static Resource JBO_C_SHIRHASHIRIMBOOK = (model.getOntClass(JBO_URI + "ShirHashirimBook"));
    public static Resource JBO_C_RUTBOOK = (model.getOntClass(JBO_URI + "RutBook"));
    public static Resource JBO_C_EYCHABOOK = (model.getOntClass(JBO_URI + "EychaBook"));
    public static Resource JBO_C_KOHELETBOOK = (model.getOntClass(JBO_URI + "KoheletBook"));
    public static Resource JBO_C_ESTERBOOK = (model.getOntClass(JBO_URI + "EsterBook"));
    public static Resource JBO_C_DANIELBOOK = (model.getOntClass(JBO_URI + "DanielBook"));
    public static Resource JBO_C_EZRABOOK = (model.getOntClass(JBO_URI + "EzraBook"));
    public static Resource JBO_C_NECHEMYABOOK = (model.getOntClass(JBO_URI + "NechemyaBook"));
    public static Resource JBO_C_DIVREYHAYAMIMABOOK = (model.getOntClass(JBO_URI + "DivreyHayamimABook"));
    public static Resource JBO_C_DIVREYHAYAMIMBBOOK = (model.getOntClass(JBO_URI + "DivreyHayamimBBook"));
